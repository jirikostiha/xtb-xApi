...
/// </summary>
public class XClient : IXApiClient, IDisposable
{
    /// <summary>
    /// Creates a new <see cref="XClient"/> instance using the provided endpoint address and ports.
    /// </summary>
    ...
    /// <returns>A new instance of <see cref="XClient"/>.</returns>
    public static XClient Create(string address, int requestingPort, int streamingPort, IStreamingListener? streamingListener = null)
    {
    ...
    /// <summary>
    /// Creates a new <see cref="XClient"/> instance using the provided endpoints.
    /// </summary>
    ...
    /// <param name="streamingListener">Optional streaming listener for handling streamed data.</param>
    /// <returns>A new instance of <see cref="XClient"/>.</returns>
    public static XClient Create(IPEndPoint requestingEndpoint, IPEndPoint streamingEndpoint, IStreamingListener? streamingListener = null)
    {
        var apiConnector = ApiConnector.Create(requestingEndpoint, streamingEndpoint, streamingListener);

        return new XClient(apiConnector)
        {
    ...
    public XClient(IClient requestingConnector, IClient streamingConnector)
        : this(
    ...
    /// <param name="streamingConnector">streaming connector.</param>
    public XClient(IClient connector, StreamingApiConnector streamingConnector)
    ...
    public XClient(ApiConnector apiConnector)
    {
